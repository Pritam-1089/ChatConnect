...
public record AuthResponseDto(string Token, int UserId, string FullName, string Email, string? AvatarUrl);
...
public record MessageDto(int Id, string Content, int SenderId, string SenderName, string? SenderAvatar, bool IsRead, DateTime SentAt);
