...
export class ChatService {
  private api = 'http://localhost:5276/api';
  ...
  updateAvatar(avatarUrl: string): Observable<{ avatarUrl: string | null }> { return this.http.put<{ avatarUrl: string | null }>(this.api + '/users/me/avatar', { avatarUrl }); }
}
